...
- Custom loss function(s) for bespoke networks? By bespoke I mean purpose-built, like a model that would reward voxels at the center of voids (or in this case distance transform contiguous regions) more than those at the edges or vice versa, etc. (see ['Creating custom losses' on this page](https://keras.io/api/losses/)) 
